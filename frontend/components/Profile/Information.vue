    ...
    <div class="px-4 py-2 bg-purple-800 border border-gradient">
      ...
      <div class="mt-8 space-y-6">
        ...
        <div class="flex items-center justify-between">
          ...
          <LoadingButton @click.native="changePassword" :status="passwordStatus">Changer</LoadingButton>
        </div>
        <div class="flex items-center justify-between">
          <div class="flex items-center space-x-4">
            <div>
          ...
          <nuxt-link
            :to="{name: 'credits'}"
            class="px-4 py-2 text-sm font-semibold text-purple-200 bg-purple-700 border border-yellow-600 rounded-md hover:bg-purple-600"
          >Acheter</nuxt-link>
        </div>
        <div class="flex items-center justify-between">
          <div class="flex items-center space-x-4">

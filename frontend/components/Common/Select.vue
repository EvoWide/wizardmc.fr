<template>
  <div class="space-y-1 text-purple-200">
    <label
    ...
    <div class="relative">
      <span class="inline-block w-full rounded-md shadow-sm">
        <button
          ...
          class="relative w-full py-2 pl-3 pr-10 text-left transition duration-150 ease-in-out bg-purple-800 border border-purple-500 cursor-default focus:outline-none focus:border-yellow-600 focus:bg-purple-900 sm:text-sm sm:leading-5"
        >
      ...
      <transition name="fade">
        ...
        >
          <ul
            ...
            class="py-1 overflow-auto text-base leading-6 shadow-xs max-h-56 focus:outline-none sm:text-sm sm:leading-5"
          >
            <li
              ...
              role="option"
              :class="{ 'text-white bg-purple-500': selected === index + 1, 'text-purple-200': !(selected === index + 1) }"
            ...
            >
              ...
              <span
                ...
                :class="{ 'text-white': selected === index + 1, 'text-purple-200': !(selected === index + 1) }"

          ...
          <th colspan="5" class="font-normal">
            <div class="px-4 pt-4 pb-6 leading-none text-left lg:text-center">
              <div class="flex items-center justify-start lg:justify-center">
                ...
                <h2 class="mx-4 text-2xl font-title lg:text-3xl">
                  Grades
                </h2>
                <img class="w-4 h-4" src="@/assets/img/badge.png" alt="badge">
              </div>
        ...
        <tr>
          ...
          <td>
            <div class="flex items-center justify-center">
              <span class="text-base font-semibold lg:text-xl">{{ ranksPrices[ranksDuration][0] }}$</span>
              <span class="ml-1 text-purple-500">/{{ ranksDuration }}</span>
            </div>
          </td>
          <td>
            <div class="flex items-center justify-center">
              <span class="text-base font-semibold lg:text-xl">{{ ranksPrices[ranksDuration][1] }}$</span>
              <span class="ml-1 text-purple-500">/{{ ranksDuration }}</span>
            </div>
          </td>
          <td>
            <div class="flex items-center justify-center">
              <span class="text-base font-semibold lg:text-xl">{{ ranksPrices[ranksDuration][2] }}$</span>
              <span class="ml-1 text-purple-500">/{{ ranksDuration }}</span>
            </div>
          </td>
          <td>
            <div class="flex items-center justify-center">
              <span class="text-base font-semibold lg:text-xl">{{ ranksPrices[ranksDuration][3] }}$</span>
              <span class="ml-1 text-purple-500">/{{ ranksDuration }}</span>
            </div>
          </td>
        </tr>
